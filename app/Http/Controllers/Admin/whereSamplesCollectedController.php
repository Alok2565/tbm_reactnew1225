...
use App\Models\whereSamplesCollected;

class whereSamplesCollectedController extends Controller
{
    public function index()
    {
        $allData = whereSamplesCollected::all();
    ...
    public function createSamplesCollectede(Request $request)
    {
        DB::beginTransaction();
        ...
        try {
            ...
            $createData = new whereSamplesCollected();
    ...
    public function showSamplesCollectedeData($id)
    {
        return whereSamplesCollected::findOrFail($id);
    }
    public function updateSamplesCollectede(Request $request, string $id)
    {
        DB::beginTransaction();
        try {
            $request->validate([
            ...
            $updateData = whereSamplesCollected::findOrFail($id);
    ...
    public function statusSamplesCollectede($id)
    {
        try {
            $stData = whereSamplesCollected::findOrFail($id);
    ...
    public function deleteSamplesCollectede($id)
    {
        try {
            $delData = whereSamplesCollected::findOrFail($id);
            $delData->delete();
