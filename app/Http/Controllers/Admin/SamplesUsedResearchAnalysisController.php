...
use App\Models\SamplesUsedResearchAnalysis;

class SamplesUsedResearchAnalysisController extends Controller
{
    public function index()
    {
        $allData = SamplesUsedResearchAnalysis::all();
    ...
    public function createUsedResearchAnalysis(Request $request)
    {
        DB::beginTransaction();
        ...
        try {
            ...
            $createData = new SamplesUsedResearchAnalysis();
    ...
    public function showUsedResearchAnalysisData($id)
    {
        return SamplesUsedResearchAnalysis::findOrFail($id);
    }

    public function updateUsedResearchAnalysis(Request $request, string $id)
    {
        DB::beginTransaction();
        try {
            $request->validate([
            ...
            $updateData = SamplesUsedResearchAnalysis::findOrFail($id);
    ...
    public function statusUsedResearchAnalysis(string $id)
    {
        try {
            $stData = SamplesUsedResearchAnalysis::findOrFail($id);
    ...
    public function deleteUsedResearchAnalysis($id)
    {
        try {
            $delData = SamplesUsedResearchAnalysis::findOrFail($id);
            $delData->delete();
