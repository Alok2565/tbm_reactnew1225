...
function Volumes() {
    ...
    const handleEdit = (id) => {
        ...
        console.log("Navigating to edit:", `/${baseRole}/volume/edit/${id}`);
        navigate(`/${baseRole}/volume/edit/${id}`);
    };
    ...
    const handleDelete = async (id) => {
        ...
        try {
            await API.delete(`/volume/delete/${id}`);
