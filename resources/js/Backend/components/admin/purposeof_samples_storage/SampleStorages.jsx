...
// function SampleStorages() {
//   return (
//     <div>SampleStorages</div>
//   )
// }
...
function SampleStorages() {
    useTitle("Purpose of Sample Storage Lists");
    ...
    const handleEdit = (id) => {
       ...
       // console.log("Navigating to edit:", `/${baseRole}/purpose_sample_storage/edit/${id}`);
        navigate(`/${baseRole}/purpose_sample_storage/edit/${id}`);
    };
    const handleStatus = async (id) => {
        try {
            const response = await API.put(
                `/purpose_sample_storage/status/${id}`
            );
    ...
    const handleDelete = async (id) => {
        ...
        try {
            await API.delete(`/purpose_sample_storage/delete/${id}`);
                    ...
                    <Col lg={12}>
                        <Stack direction="horizontal" gap={3} className="mb-3">
                            ...
                            <div className="ms-auto">
                                <Link
                                    to={`/${role || "admin"}/purpose_sample_storage/add_new`}
