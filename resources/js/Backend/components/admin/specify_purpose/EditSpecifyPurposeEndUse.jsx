...
// function EditSpecifyPurposeEndUse() {
//   return (
//     <div>EditSpecifyPurposeEndUse</div>
//   )
// }

// export default EditSpecifyPurposeEndUse
...
function EditSampleCollected() {
   ...
   useEffect(() => {
        API.get(`specify_purpose/${id}`).then((res) => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            await API.put(`/specify_purpose/update/${id}`, {
                name,
                value,
            },
        {
            ...
            navigate(`/${role}/specify_purpose_end_uses`); 
        } catch (error) {
