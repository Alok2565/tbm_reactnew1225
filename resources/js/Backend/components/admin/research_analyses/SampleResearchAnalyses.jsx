...
function SampleResearchAnalyses() {
    useTitle("Sample Research Lists");
    ...
    const handleEdit = (id) => {
        ...
        console.log("Navigating to edit:", `/${baseRole}/used_research_analysis/edit/${id}`);
        navigate(`/${baseRole}/used_research_analysis/edit/${id}`);
    };
    const handleStatus = async (id) => {
        try {
            const response = await API.put(
                `/used_research_analysis/status/${id}`
            );
    ...
    const handleDelete = async (id) => {
        ...
        try {
            await API.delete(`/used_research_analysis/delete/${id}`);
                    ...
                    <Col lg={12}>
                        <Stack direction="horizontal" gap={3} className="mb-3">
                            ...
                            <div className="ms-auto">
                                <Link
                                    to={`/${role || "admin"}/used_research_analysis/add_new`}
...
export default SampleResearchAnalyses;
