...
// export default NaturalBiomaterials
...
function NaturalBiomaterials() {
    useTitle("Natural Biomaterial Lists");
    ...
    const handleEdit = (id) => {
        ...
        console.log("Navigating to edit:", `/${baseRole}/natural_biomaterial/edit/${id}`);
        navigate(`/${baseRole}/natural_biomaterial/edit/${id}`);
    };
    const handleStatus = async (id) => {
        try {
            const response = await API.put(
                `/natural_biomaterial/status/${id}`
            );
    ...
    const handleDelete = async (id) => {
        ...
        try {
            await API.delete(`/natural_biomaterial/delete/${id}`);
                    ...
                    <Col lg={12}>
                        <Stack direction="horizontal" gap={3} className="mb-3">
                            ...
                            <div className="ms-auto">
                                <Link
                                    to={`/${role || "admin"}/natural_biomaterial/add_new`}
