                ...
                <Container fluid>
                    ...
                    <Card>
                        <Row className="mb-4">
                            ...
                            <ProgressBar now={(step / 3) * 100} className="mb-4 mt-4" />
                        </Row>
                                    ...
                                    {step === 1 && (
                                        <>
                                            ...
                                            <Card.Body>
                                                ...
                                                <Col className="d-flex justify-content-between mt-2 m-2">
...
//   useEffect(() => {
//     const draft = localStorage.getItem("nocDraft");
...
//   const saveAsDraft = () => {
//     localStorage.setItem("nocDraft", JSON.stringify(formData));
...
//       localStorage.removeItem("nocDraft");
...
//                   {step > 1 && (
//                     <Button variant="danger d-flex gap-1" onClick={prevStep}>
//                       <FaArrowLeft/>Back to Previous
//                     </Button>
//                   )}

//                   <div className="ms-auto d-flex gap-2">
//                     <Button variant="warning" onClick={saveAsDraft}>
//                       Save as Draft
//                     </Button>

//                     {step < 3 ? (
//                       <Button variant="primary d-flex p-2 gap-1" onClick={nextStep}>
//                         Add More Info <FaArrowRight/>
//                       </Button>
//                     ) : (
...
//         <Modal.Header closeButton>
//           <Modal.Title>
//             {modalType === "confirm" ? "Confirm Submission" : "Validation Error"}
//           </Modal.Title>
//         </Modal.Header>
...
//             : "All fields are required. Field should not be blank."}
//         </Modal.Body>
...
//           </Button>
//           <Button
//             variant={modalType === "confirm" ? "success" : "danger"}
